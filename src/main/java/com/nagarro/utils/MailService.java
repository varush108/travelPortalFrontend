...
public class MailService {
	 ...
	 * @throws MessagingException
	 */
	public void sendEmailWithAttachment(EmailUser user) throws MailException, MessagingException {
		...
		ClassPathResource classPathResource = new ClassPathResource("file.pdf");
